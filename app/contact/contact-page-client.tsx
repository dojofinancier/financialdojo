              ...
              <div className="max-w-2xl">
                <div className="border-l-4 border-primary pl-6 py-2">
                  <p className="text-xl sm:text-2xl font-light leading-relaxed opacity-80">
                    A question? Need help? We are here for you.
                  </p>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="formation">Course question</option>
                      <option value="inscription">Enrollment</option>
              ...
              <div className="space-y-8">
                <div className="border-4 border-white p-8">
                  ...
                  <div className="space-y-6 font-mono text-sm">
                    <div>
                      <div className="uppercase tracking-wider opacity-70 mb-2">EMAIL</div>
                      <a href="mailto:hello@financedojo.com" className="hover:text-primary transition-colors">
                        hello@financedojo.com
                      </a>
                    </div>
                    <div>
                      <div className="uppercase tracking-wider opacity-70 mb-2">ADDRESS</div>
                      <div>Montreal, Quebec</div>
                    </div>
                    <div>
                      <div className="uppercase tracking-wider opacity-70 mb-2">HOURS</div>
